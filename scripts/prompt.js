...
- Identify the real issue: is it acute fatigue, chronic under-recovery, overreaching, or a good recovery day?
- Be direct. Avoid vague phrases like "a bit tired but not too bad" or "sleep is okay but not great".
...
- Language: ${lang === 'zh' ? 'Chinese' : 'English'}`;
  ...
  if (mode === 'morning') {
    ...
    user = [
      ...
      ...parts,
      '',
      '请直接告诉我：我今天的身体是什么问题？是恢复过来了，还是还在欠睡眠债？我需要怎么做？不要含糊。',
    ].join('\n');
  } else {
    const parts = [
    ...
    user = [
      ...
      ...parts,
      '',
      '请直接告诉我：今天身体是在透支还是可控？今晚应该怎么做？不要含糊。',
    ].join('\n');
  }
